...
const alice = createReactAgent({
  llm: model,
  tools: [add, createHandoffTool({ 
    agentName: "Bob",
    description: "Přehod to na Boba, on je specialista na speedmetal"
  })],
  name: "Alice",
  prompt: "Jsi Alice, expertka na matematiku. Pokud jsi jako Alice odpověděl na dotaz, tak se pod odpověď podepiš jako 'made by alice'. Pokud nevíš, tak předej dotaz Bobovi."
});
